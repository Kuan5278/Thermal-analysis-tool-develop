# universal_analysis_platform_v6_final.py
...
def parse_yokogawa(file_content, is_excel=False):
    try:
        ...
        # 3. 智慧組合最終的標頭
        # 前3個欄位使用第30行的標頭 (Date, Time, sec)
        final_columns = main_header_30.tolist()[:3] 
        # 從第4個欄位開始，使用第29行的Tag
        final_columns.extend(tag_row_29.tolist()[3:])
